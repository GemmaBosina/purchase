...
<thead class="fixedHeader">
           <tr>
						  ...
						  <th  style="width:156px;" align="left">Status</th>				 
						  <th style="width:140px;" align="left">Change <br/>Status </th> 
						  <th style="width:300px;" align="left">Requestor</th>
						  <th  style="width:300px;" align="left">Suprvisor</th>
						  <th  style="width:140px;" align="left">Program</th>
						  <th  style="width:156px;" align="left">Must be delivered by</th> 
						  <th  style="width:156px;" align="left">Form of Purchse</th> 
						  <th  style="width:300px;" align="left">Vendor<br/>Info</th>
						  <th  style="width:300px;" align="left">Purchase<br/>Purpose</th>
						  <th  style="width:156px;" align="left">Purchase<br/>Details</th>
						  <th  style="width:156px;" align="left">Comments</th>
						  <th  style="width:140px;" align="left">Submission<br/>Date</th>						
                    </tr></thead>
...
//////////////end sql select data from directory
 ...
 echo '                                           <td style="width: 72px; word-wrap: break-word">'.$row[id].'</td>
						  <td  style="width: 156px; word-wrap: break-word">'.$row[status].'</td>						 
						  ...
						  <td  style="width: 300px; word-wrap: break-word">'.$row[requestor_name].'</td>
						  <td  style="width: 300px; word-wrap: break-word">'.$supervisor.'</td>
						  <td  style="width: 140px; word-wrap: break-word">'.$row[unit].'</td>
						  <td  style="width: 156px; word-wrap: break-word">'.$row[deliver].'</td> 
						  <td  style="width: 156px; word-wrap: break-word">'.$row[form_purchase].'</td> 
						  <td  style="width: 300px; word-wrap: break-word">Vendor: '.$row[vendor_name].'<br/>Contact: '.$row[vendor_contact].'<br/>Phone: '.$row[vendor_phone].'<br/> Website: <a style="color: #ba0c2f" href="'.$row[vendor_website].'" data-toggle="tooltip" data-placement="top" title="'.$row[vendor_website].'">Click here</a><br/></td>
						  <td  style="width: 300px; word-wrap: break-word">'.$row[purpose].'</td>
						  <td  style="width: 156px; word-wrap: break-word">
			    ...
			    <div class="modal fade bs-example-modal-lg" id="'.$row[id].'comments" tabindex="100" role="dialog" aria-labelledby="myLargeModalLabel">
				  ...
				  '.$row[comments].'				<div>
						...
						<td  style="width: 140px; word-wrap: break-word">'.$row[date_submission].'</td>
